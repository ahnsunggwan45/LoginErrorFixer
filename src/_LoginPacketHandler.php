...
final class _LoginPacketHandler extends PacketHandler
{
     ...
     */
    protected function fetchAuthData(JwtChain $chain): _AuthenticationData
    {
        /** @var _AuthenticationData|null $extraData */
        $extraData = null;
        foreach ($chain->chain as $k => $jwt) {
            ...
            if (isset($claims["extraData"])) {
                ...
                try {
                    ...
                    $extraData = $mapper->map($claims["extraData"], new _AuthenticationData());
